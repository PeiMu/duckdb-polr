...
#
## create schema
#echo "create imdb_polr schema"
#echo -ne ".read imdb_schema.sql" | duckdb ./imdb_polr.db
#
## load imdb
...
#  echo $command
#  echo -ne "${command}" | duckdb ./imdb_polr.db
#done
...
for i in $(eval echo {1.."${iteration}"}); do
  for sql in "${dir}"/*; do
    ...
    echo -ne ".read ${sql}" | duckdb ./imdb_polr.db 2>&1|tee -a ${log_name};
  done
done
