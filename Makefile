...
ifeq (${ENABLE_QUERY_SPLIT}, 1)
	EXTENSIONS:=${EXTENSIONS} -DDEFINE_QUERY_SPLIT=1
else
	EXTENSIONS:=${EXTENSIONS} -DDEFINE_QUERY_SPLIT=0
endif

ifeq (${ENABLE_PARALLEL_EXECUTION}, 1)
	EXTENSIONS:=${EXTENSIONS} -DDEFINE_PARALLEL_EXECUTION=1
else
	EXTENSIONS:=${EXTENSIONS} -DDEFINE_PARALLEL_EXECUTION=0
endif

ifeq (${ENABLE_DEBUG_PRINT}, 1)
	EXTENSIONS:=${EXTENSIONS} -DDEFINE_DEBUG_PRINT=1
else
	EXTENSIONS:=${EXTENSIONS} -DDEFINE_DEBUG_PRINT=0
endif

ifeq (${ENABLE_CROSS_PRODUCT_REWRITE}, 1)
	EXTENSIONS:=${EXTENSIONS} -DDEFINE_CROSS_PRODUCT_REWRITE=1
else
	EXTENSIONS:=${EXTENSIONS} -DDEFINE_CROSS_PRODUCT_REWRITE=0
endif

ifeq (${ENABLE_MERGE_BACK_PLAN}, 1)
	EXTENSIONS:=${EXTENSIONS} -DDEFINE_MERGE_BACK_PLAN=1
else
	EXTENSIONS:=${EXTENSIONS} -DDEFINE_MERGE_BACK_PLAN=0
endif

ifeq (${ENABLE_SPECIFY_EST_STAT}, 1)
	EXTENSIONS:=${EXTENSIONS} -DDEFINE_SPECIFY_EST_STAT=1
else
	EXTENSIONS:=${EXTENSIONS} -DDEFINE_SPECIFY_EST_STAT=0
endif

ifeq (${ENABLE_MEASURE_EXE_TIME}, 1)
	EXTENSIONS:=${EXTENSIONS} -DDEFINE_MEASURE_EXE_TIME=1
else
	EXTENSIONS:=${EXTENSIONS} -DDEFINE_MEASURE_EXE_TIME=0
endif
